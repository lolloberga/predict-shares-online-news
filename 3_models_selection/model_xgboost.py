...
params = {
    "max_depth": [4,7,10],
    "min_child_weight": [5,7,9, 15, 20],
    "eta": [0.05, 0.07, 0.1, 0.5],
    "eval_metric": [mean_squared_error],
}

gs = GridSearchCV(XGBRegressor(), param_grid=params, cv=5, scoring='r2', verbose=3, n_jobs=-1)
...
new_df.to_csv('../output/xgbr_results.csv', columns=['Id','Predicted'], index=False)